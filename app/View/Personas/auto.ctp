...
<!-- Modal Body -->
<?php echo $this->Form->create('Auto',array('action' => 'guarda_auto','class' => 'form-horizontal form-bordered'));?>
<div class="modal-body">             
    ...
    <div class="form-group"> 
        ...
        <?php echo $this->Form->text('modelo', array('class' => 'form-control', 'placeholder' => 'Ingrese el color', 'required')); ?>
    </div>
    <div class="form-group"> 
    ...
    <div class="form-group"> 
        ...
        <?php echo $this->Form->text('fabricacion', array('class' => 'form-control', 'placeholder' => 'Ingrese el a;o fabricacion', 'required')); ?>
    </div>
